  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering Teams with HR Management System - Streamline Employee Data, Vacation Planning, Time Tracking, Payroll, and Performance Evaluations in One Centralized Platform"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Teams with HR Management System - Streamline Employee Data, Vacation Planning, Time Tracking, Payroll, and Performance Evaluations in One Centralized Platform`}
            </Text>
            <Box
